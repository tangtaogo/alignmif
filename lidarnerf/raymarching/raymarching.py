...
class _composite_rays_train(Function):
    ...
    def backward(ctx, grad_weights_sum, grad_depth, grad_image):
        ...
        _backend.composite_rays_train_backward(grad_weights_sum, grad_image,
                                               ...
                                               T_thresh, grad_sigmas, grad_rgbs)
...
class _composite_rays(Function):
    ...
    def forward(ctx,
        ...
        In-place Outputs:
            ...
            image: float, [N, 3], the RGB channel (after multiplying alpha!)
        """
        _backend.composite_rays(n_alive, n_step, T_thresh, rays_alive, rays_t,
                                sigmas, rgbs, deltas, weights_sum, depth, image)
        return tuple()
